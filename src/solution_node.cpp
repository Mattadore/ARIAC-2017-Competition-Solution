...
//todo: add member to bins that specifies if a drop happened there.
//search these bins if out of parts
//do timing for grab, gripper moves down over course of action
//try/catch the main logic
